...
.conda-env-anchor{display:inline-flex;align-items:center;position:relative;min-width:0;color:var(--dsw-alias-label-secondary,#52525b);font-family:var(--dsw-font-family,Inter,ui-sans-serif,system-ui,sans-serif)}
.conda-env-trigger{display:inline-flex;align-items:center;gap:4px;min-width:0;max-width:220px;height:28px;margin:0;padding:0 4px 0 8px;border:0;border-radius:24px;outline:none;background:transparent;color:inherit;font-size:13px;font-weight:500;line-height:20px;white-space:nowrap;cursor:pointer}
.conda-env-trigger:hover:not(:disabled),.conda-env-trigger[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover,#f5f5f5)}.conda-env-trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3,#d4d4d8)}
.conda-env-trigger-label{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.conda-env-trigger-effort{flex:0 0 auto;color:var(--dsw-alias-label-tertiary,#737373);font-size:13px;font-weight:500}.conda-env-chevron{display:inline-flex;flex:0 0 auto;color:var(--dsw-alias-label-caption,#737373);transition:transform .12s}.conda-env-trigger[aria-expanded=true] .conda-env-chevron{transform:rotate(180deg)}
.conda-env-menu{position:fixed;z-index:100;width:260px;max-width:calc(100vw - 24px);max-height:300px;overflow:auto;padding:8px;background:#fff;border:1px solid #e8e8e8;border-radius:14px;box-shadow:0 12px 32px rgb(0 0 0 / 12%)}
.conda-env-option{display:grid;grid-template-columns:20px minmax(0,1fr) 20px;align-items:center;gap:8px;width:100%;min-height:42px;padding:7px 8px;border:0;border-radius:8px;background:transparent;color:#171717;text-align:left;font:14px/18px Inter,ui-sans-serif,system-ui,sans-serif;cursor:pointer}.conda-env-option:hover{background:#f5f5f5}.conda-env-option-icon{color:#737373;text-align:center}.conda-env-option-copy{min-width:0}.conda-env-option-name{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.conda-env-option-path{display:block;margin-top:2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#8a8a8a;font-size:11px}.conda-env-check{font-size:18px;text-align:center}.conda-env-error{color:#dc2626}
body[data-ds-dark-theme] .conda-env-menu{background:#202020;border-color:#363636;box-shadow:0 14px 36px #0008}body[data-ds-dark-theme] .conda-env-option{color:#ededed}body[data-ds-dark-theme] .conda-env-option:hover{background:#303030}
`;
